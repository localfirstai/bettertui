...
const AstroWordmarkDark = (props: IconProps) => (
  <svg {...props} role="img" aria-label="Astro" viewBox="0 -6 381 100">
    <defs>
      <linearGradient id="a" x1="21" x2="64.6" y1="100" y2="79.4" gradientUnits="userSpaceOnUse">
