# BetterTUI vs Reference: Viewport Culling Comparison

## Rendering Architecture

| Aspect           | Reference                                                                       | BetterTUI                                                                      |
| ---------------- | ------------------------------------------------------------------------------- | ------------------------------------------------------------------------------ |
| --------         | ---------                                                                       | -----------                                                                    |
...
## Optimisations Present Only in Reference
