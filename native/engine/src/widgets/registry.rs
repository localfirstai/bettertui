...
mod tests {
    ...
    impl crate::widgets::Widget for DummyWidget {
        ...
        fn create(
            &self,
            _ctx: &mut crate::widgets::context::WidgetContext,
        ) -> crate::widgets::WidgetId {
            crate::widgets::WidgetId(crate::tree::NodeId::default())
        }
    }
